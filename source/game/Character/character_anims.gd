...
@onready var clipboard : BoneAttachment3D = $"..//Camera3D/Arms_skeleton_v002/arms_armature/Skeleton3D/BoneAttachment3D_handL"
@onready var pencil : BoneAttachment3D = $"..//Camera3D/Arms_skeleton_v002/arms_armature/Skeleton3D/BoneAttachment3D_handR"
